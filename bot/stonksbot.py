...
async def on_message(message):
    ...
    if message.content.startswith('$stonks'):
        try:
            ...
            await edit_message(sentMessage.id,'Getting stonks, this may take some time..')
            ...
            await edit_message(sentMessage.id,toSend.format(stock=ticker,pps=price,high=result['candles'][0]['high'],low=result['candles'][0]['low']))
        except api.APIError:
