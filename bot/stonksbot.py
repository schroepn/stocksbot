...
async def on_message(message):
    ...
    if message.content.startswith('$stonks'):
        try:
            ...
            await discord.Message.edit(self=sentMessage.id,content='Getting stonks, this may take some time..')
            ...
            await discord.Message.edit(self=sentMessage.id,content=toSend.format(stock=ticker,pps=price,high=result['candles'][0]['high'],low=result['candles'][0]['low']))
        except api.APIError:
